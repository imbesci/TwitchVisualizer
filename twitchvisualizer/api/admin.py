...
class ThreeMinuteDataAdmin(admin.ModelAdmin):
...
admin.site.register(apimodels.ThreeMinuteData, ThreeMinuteDataAdmin)
...
admin.site.register(apimodels.TimeKeeping)
